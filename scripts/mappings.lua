...
CONST_DEVICES = importDevices {
    ...
    { 0x1300, "MASCHINE_STUDIO", "MSTUDIO", "Maschine Studio", niproto.CONST_PORT_MAIN, 300, 2, 272, 480 }, -- ledcnt -> 300 to reach transport/GROUP/knob LEDs via the mapping tool (dcnt, dheight, dwidth)
