...
CONST_DEVICES = importDevices {
    ...
    { 0x1300, "MASCHINE_STUDIO", "MSTUDIO", "Maschine Studio", niproto.CONST_PORT_MAIN, 213, 2, 272, 480 }, -- ledcnt = 213 (true count, confirmed by probe: nothing lights above 213). dcnt, dheight, dwidth.
