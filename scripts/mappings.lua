...
CONST_DEVICES = importDevices {
    ...
    { 0x1300, "MASCHINE_STUDIO", "MSTUDIO", "Maschine Studio", niproto.CONST_PORT_MAIN, 200, 2, 272, 480 }, -- ledcnt 103->200 to reach transport/GROUP/knob LEDs via the mapping tool (dcnt, dheight, dwidth)
